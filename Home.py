...
# ===== Validação/Renovação de sessão (sem importar pages.Login!) =====
# Precisamos do gc aqui também para utils/sessoes
import json
import gspread
...
if not email_atual or not token_atual or not validar_sessao(gc, PLANILHA_KEY, email_atual, token_atual):
...
atualizar_sessao(gc, PLANILHA_KEY, email_atual)
